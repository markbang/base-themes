...
Base Themes is a package-first React component system built on `@base-ui/react`. It ships typed component wrappers, CSS token themes, 22 visual styles, product blocks, registry metadata, CLI helpers, and agent-readable docs.
